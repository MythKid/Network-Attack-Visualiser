...
API routes (:mod:`app.api`). Phase 4 adds the React dashboard, and Phase 5 adds
the PCAP replay ingester (:mod:`app.ingest.pcap_replay`) and the unprivileged
scenario generator. Live capture and the AI layer are introduced in later phases
